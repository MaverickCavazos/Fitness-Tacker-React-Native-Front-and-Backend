...
function WelcomeScreen({ navigation }) {
    return (
        ...
        >   
            ...
            <TouchableOpacity onPress={() =>{ navigation.navigate("Register") }} activeOpacity={0.6} style={styles.loginButton}><Text style={styles.loginText}>Login</Text></TouchableOpacity>
